    ...
    <section class='login-content'>
      ...
      <div class='login-box'>
        <form method='POST' class='login-form' action='login.php'>
          ...
          <div class='form-group'>
            <label class='control-label'>SE CONNECTER EN TANT QUE</label>
            <select name='login_as' class='form-control' type='password' placeholder='Password'>
                <option><?php echo $select; ?></option>
                <option value="Admin">Administrateur</option>
                <option value="Student">Étudiant</option>
                <option value="Accountant">Principal</option>
                <option value="Principal">Comptable</option>
            ...
            <div class='utility'>
              <div class='animated-checkbox'>
                <label class='semibold-text'>
                    <a href="../index.php" class='label-text'><i class='fa fa-home'></i> Accueil</a>
                </label>
              </div>
          ...
          <div class='form-group btn-container'>
            <button name='login_btn' class='btn btn-primary btn-block'><i class='fa fa-sign-in fa-lg fa-fw'></i>SE CONNECTER</button>
          </div>
        </form>
        <form class='forget-form' action='index.html'>
          ...
          <div class='form-group btn-container'>
            <button class='btn btn-primary btn-block'><i class='fa fa-unlock fa-lg fa-fw'></i>RÉINITIALISER</button>
          </div>
          <div class='form-group mt-20'>
            <p class='semibold-text mb-0'><a data-toggle='flip'><i class='fa fa-angle-left fa-fw'></i> Retour connexion</a></p>
          </div>
        </form>
      </div>
    </section>
